...
- **Note:** Always add new entries at the top of this section.
...
🟦 Frontend Agent Log
- _All frontend messages, newest first._
- **Note:** Always add new entries at the top of this section.
...
🟨 PM Log
- _All PM messages, newest first._
- **Note:** Always add new entries at the top of this section.
...
- **Note:** Move resolved threads to the agent logs.
